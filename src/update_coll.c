...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/23 11:56:56 by iel-amra          #+#    #+#             */
/*   Updated: 2022/02/23 12:02:55 by iel-amra         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
	...
	while (i < small->img->x && i + small->x - big->x < big->img->x)
	{
		...
		while (j < small->img->y && j + small->y - big->y < big->img->x)
		{
			if (i + small->x - big->x > 0 && j + small->y - big->y > 0
				...
				&& my_mlx_pixel_get(big->img, i + small->x - big->x,
					j + small->y - big->y) != 0xFF000000)
				nb++;
			j++;
		}
		i++;
